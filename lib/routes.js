...
FlowRouter.route('/editCategories', {
    name: 'editCategories',
    action: function() {
        BlazeLayout.render('MainLayout', {main: 'editCategories'});
    }
});
...
FlowRouter.route('/importQuestions', {
    name: 'importQuestions',
    action: function() {
        BlazeLayout.render('MainLayout', {main: 'importQuestions'});
    }
});
...
FlowRouter.route('/challengeGame', {
    name: 'challengeGame',
    action: function() {
        BlazeLayout.render('MainLayout', { main: 'challengeGame' });
    }
});
